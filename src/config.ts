...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/hinokivillage.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
		position: "center", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
		credit: {
			enable: true, // Display the credit text of the banner image
			text: "我@嘉義", // Credit text to be displayed
...
/* 		{
		...
		}, */
		{
			...
			url: "https://instagram.com/blado.tf",
		},
		{
			name: "GitHub",
